#!/bin/bash
# Iter 13: Light KL + retain_momentum=0.99 (test if extra smoothing helps).
set +e
...
echo "[$(date)] Iter13 pilot: light_kl + mom=0.99 — Llama Bio"
$BASE $SC \
    ...
    task_name=iter13_lightkl_mom099_llama_bio
