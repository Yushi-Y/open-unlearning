#!/bin/bash
# Iter 10: Candidate C extreme — frac=0.95 (reject 95% of gnorm*quad_r). Final push.
set +e
...
echo "[$(date)] Iter10 pilot: C frac=0.95 — Llama Bio"
$BASE $SC \
    ...
    +trainer.method_args.cfg.token_filter_tau=0.95 \
    task_name=iter10_candC_frac095_llama_bio
