...
"""DISCO with gradient orthogonalization instead of binary KL masking.

Same as DISCO iter8 (act+grad DISCO collapse, LoRA adversary) but replaces
binary KL token masking with continuous gradient projection — projects out
the disruptive component instead of dropping the entire token.
"""
import logging
import math
import random
...
class GradOrth(UnlearnTrainer):
    """DISCO collapse + gradient orthogonalization + LoRA adversary."""
    ...
    def __init__(self, cfg, *args, **kwargs):
        ...
        # KL gradient tracking for orthogonalization
    ...
    def training_step(self, model, inputs, num_items_in_batch=None):
        ...
        # KL gradient for orthogonalization (after epoch 0)
